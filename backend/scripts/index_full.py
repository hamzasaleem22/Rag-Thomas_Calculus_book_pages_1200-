"""Index full book into Qdrant (local persistent mode) and save BM25 state."""
...
from app.ingestion.indexer import index_documents, index_documents_and_return_bm25
...
# Use Qdrant local persistent mode instead of in-memory + pickle
...
print(f"Saved BM25 state ({len(bm25.vocab)} vocab, {bm25.num_docs} docs)")

print(f"\n✅ Qdrant DB persisted at: {QDRANT_DB_PATH}")
print(f"✅ BM25 state persisted at: /tmp/qdrant_calculus_bm25.pkl")
